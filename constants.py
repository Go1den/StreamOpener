...
TWITCH_USER_UNFOLLOWS_LINK = "https://api.twitch.tv/helix/users/follows"
...
MSG_STREAMS_UNFOLLOWED = "The selected streams were successfully unfollowed."
MSG_UNFOLLOW_FAILED = "Twitch did not process the unfollow request."
MSG_ABOUT_TO_UNFOLLOW = "You are about to unfollow all streams you selected. Proceed?"
