...
from constants.labelConstants import LABEL_CANCEL, LABEL_OK, LABEL_LEFT, LABEL_RIGHT, LABEL_UP, LABEL_DOWN, LABEL_TEAM_WINDOW, LABEL_FREE_AGENTS, LABEL_TEAM_MEMBERS, \
    LABEL_TEAMS_DROPDOWN, LABEL_ALL_TEAM, LABEL_CREATE_NEW_TEAM, LABEL_RENAME, LABEL_DELETE
