...
class FilterWindow:
    ...
    def initializeWindow(self):
        ...
        self.window.title(LabelConstants.LABEL_FILTER_WINDOW)
    ...
    def addFilterListbox(self):
        labelFilterGameListbox = Label(self.filterFrame, text=LabelConstants.LABEL_FILTER_GAME_LISTBOX)
        ...
        labelFilterStreamerListbox = Label(self.filterFrame, text=LabelConstants.LABEL_FILTER_STREAMER_LISTBOX)
        ...
        labelFilterCombinedListbox = Label(self.filterFrame, text=LabelConstants.LABEL_FILTER_COMBINED_LISTBOX)
    ...
    def addButtons(self):
        buttonNewFilter = Button(self.buttonFrame, text=LabelConstants.LABEL_NEW_FILTER, width=13, command=lambda: NewFilterWindow(self))
        buttonNewFilter.grid(row=0, column=0, sticky=NSEW, padx=(8, 4), pady=4)
        buttonRemove = Button(self.buttonFrame, text=LabelConstants.LABEL_DELETE, width=13, command=lambda: self.delete())
        buttonRemove.grid(row=0, column=1, sticky=NSEW, padx=4, pady=4)
        buttonOk = Button(self.buttonFrame, text=LabelConstants.LABEL_OK, width=13, command=lambda: self.ok())
        buttonOk.grid(row=0, column=2, sticky=NSEW, padx=4, pady=4)
        buttonCancel = Button(self.buttonFrame, text=LabelConstants.LABEL_CANCEL, width=13, command=lambda: self.window.destroy())
    ...
    def delete(self):
        self.deleteByListbox(self.filterGameListbox, LabelConstants.LABEL_FILTER_KEY_GAME)
        self.deleteByListbox(self.filterStreamListbox, LabelConstants.LABEL_FILTER_KEY_STREAMER)
        self.deleteByListbox(self.filterCombinedListbox, LabelConstants.LABEL_FILTER_KEY_COMBINED)
    ...
    def addFilter(self, key: str, newFilter: dict):
        ...
        if key == LabelConstants.LABEL_FILTER_KEY_GAME:
            alphabeticallyInsert(self.filterGameListbox, description)
        elif key == LabelConstants.LABEL_FILTER_KEY_STREAMER:
            alphabeticallyInsert(self.filterStreamListbox, description)
        elif key == LabelConstants.LABEL_FILTER_KEY_COMBINED:
