...
from constants import FILE_STREAMOPENER_ICON, LABEL_NEW_FILTER_WINDOW, LABEL_STREAMER, LABEL_GAME, LABEL_OK, LABEL_CANCEL, LABEL_NEW_FILTER_INSTRUCTIONS, LABEL_ALL_TEAM, \
    LABEL_ERROR, MSG_NO_FILTER_INFO_PROVIDED, LABEL_FILTER_KEY_COMBINED, LABEL_FILTER_KEY_STREAMER, LABEL_FILTER_KEY_GAME, MSG_FILTER_ALREADY_EXISTS, MSG_INVALID_GAME
